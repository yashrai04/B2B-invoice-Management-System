...
public class Invoice {
    ...
    private int uniqueCustNumber;

    // Parameterized Constructor
    public Invoice(int Sl_no, int customerOrderID, int salesOrg, String distributionChannel, String division,
                   ...
                   float amountInUsd, int uniqueCustNumber) {
        this.Sl_no=Sl_no;
    ...
    public Invoice(int Sl_no,int customerOrderID, int salesOrg, String distributionChannel,int customerNumber, int companyCode,String orderCurrency,
    		 float amountInUsd, String orderCreationDate) {
 this.Sl_no=Sl_no;
 this.customerOrderID = customerOrderID;
 this.salesOrg = salesOrg;
 this.distributionChannel = distributionChannel;
 ...
 this.amountInUsd = amountInUsd;
    ...
    public Invoice(int customerOrderID, int salesOrg, String distributionChannel,int customerNumber, int companyCode,String orderCurrency,
   		 float amountInUsd, String orderCreationDate) {
...
this.amountInUsd = amountInUsd;
    ...
    public void setSalesOrg(int salesOrg2) {
        this.salesOrg = salesOrg2;
    }
    ...
    public int getUniqueCustNumber() {
        return uniqueCustNumber;
    }

    public void setUniqueCustNumber(int uniqueCustNumber) {
        this.uniqueCustNumber = uniqueCustNumber;
    }
